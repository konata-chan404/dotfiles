;;; themes/doom=galaxy.el -*- lexical-binding: t; -*-

;;; doom-galaxy-theme.el --- dark variant of Nord -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-galaxy-theme nil
  "Options for the `doom-galaxy' theme."
  :group 'doom-themes)

(defcustom doom-galaxy-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-galaxy-theme
  :type 'boolean)

(defcustom doom-galaxy-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-galaxy-theme
  :type 'boolean)

(defcustom doom-galaxy-comment-bg doom-nord-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-galaxy-theme
  :type 'boolean)

(defcustom doom-galaxy-padded-modeline doom-themes-padded-modeline
...
(eval-and-compile
  (defcustom doom-galaxy-region-highlight t
...
(def-doom-theme doom-galaxy
  ...
  ((bg         '("#FF3440" nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        blue)
   (comments       (if doom-galaxy-brighter-comments dark-cyan (doom-lighten base5 0.2)))
   (doc-comments   (doom-lighten (if doom-galaxy-brighter-comments dark-cyan base5) 0.25))
   (constants      blue)
   (functions      cyan)
   (keywords       blue)
   (methods        cyan)
   ...
   (variables      base7)
   (numbers        magenta)
   (region         (pcase doom-galaxy-region-highlight
                     (`frost teal)
                     (`snowstorm base7)
                     (_ base4)))
   (error          red)
   ...
   (-modeline-bright doom-galaxy-brighter-modeline)
   (-modeline-pad
    (when doom-galaxy-padded-modeline
      (if (integerp doom-galaxy-padded-modeline) doom-nord-padded-modeline 4)))

   (region-fg
    (when (memq doom-galaxy-region-highlight '(frost snowstorm))
      base0))
  ...
  ((fringe :foreground teal)
   ...
   ((font-lock-comment-face &override)
    :background (if doom-galaxy-comment-bg (doom-lighten bg 0.05)))
...
;;; doom-galaxy-theme.el ends here
